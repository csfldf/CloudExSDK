            ...
            if isUp:
                ...
                if avNow >= AVSLA:
                    ...
                    if amount > 0:
                        ...
                        if amount > 0:
                            raise Exception('could not launch ' + vmsShouldBeLaunched + ' vms!')
                    return True
        ...
        for regionName in topoDic:
            ...
            for az in regionAZs:
                ...
                if vmsInAz:
                    ...
                    azTreeNode = TopoTreeNode(newAZ.name, AZAvailability)
...
class AvailabilityZone(object):
    def __init__(self, name, distance, region, maxVMCount=3):
        self.name = name
